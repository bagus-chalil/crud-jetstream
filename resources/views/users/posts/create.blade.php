        ...
        <x-splade-form action="/posts" class="flex flex-col gap-4" enctype='multipart/form-data'>
            <div class="flex gap-4">
                ...
                <div class="w-1/2 flex flex-col gap-4">
                    ...
                    <x-splade-file name="photo" :show-filename="true" label="Image" />
                    <x-splade-input name="name" type="text" label="Title" placeholder="Input your title post" />
                    <x-splade-textarea name="keterangan" autosize label="Content" />
                ...
                {{-- preview image --}}
                <div class="w-1/2">
                    <div class="flex flex-col gap-4" v-if="form.photo">
                        <div class="border-b p-2">
                            <h1 class="text-lg text-gray-700 font-semibold">PREVIEW IMAGE</h1>
                        </div>
                        <img v-if="form.photo" :src="form.$fileAsUrl('photo')" class="rounded-md" />
                    </div>
                </div>
            </div>
        </x-splade-form>
